...
<HEAD>
    ...
    <style>
        .banner {
            background-image: linear-gradient(to right, #005b8e, #94b2d6);;
...
<BODY>
    ...
    <div class="banner">
        <div class="container">
            <h1 class="banner-title">About Tech Shop</h1>
            <p class="banner-subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
